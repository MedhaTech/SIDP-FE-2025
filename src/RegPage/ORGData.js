...
export const mandalList = {
  ...
  "NEW DELHI": ["Chanakya Puri", "Delhi Cantonment", "Vasant Vihar"],
  ...
  "NORTH EAST": ["Karawal Nagar", "Seelam Pur", "Yamuna Vihar"],
  ...
  "RUDRA PRAYAG": ["Basukedar", "Jakholi*", "Rudraprayag", "Ukhimath"],
  RUPNAGAR: [
    "Anandpur Sahib",
    "Chamkaur Sahib",
    "Morinda",
