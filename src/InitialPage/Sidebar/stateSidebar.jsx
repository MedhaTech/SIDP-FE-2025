      ...
      <div id="sidebar-menu-3" className="sidebar-menu">
        <ul className="nav">
          <li className="submenu">
            ...
            >
              <Grid />
              <span>State Coordinators Dashboard</span>{" "}
            ...
            <ul style={{ display: isActive ? "block" : "none" }}>
              <li className="submenu">
                ...
                <ul style={{ display: subActive ? "block" : "none" }}>
                  <li>
                    <Link to="/state-dashboard">Admin Dashboard</Link>
                  </li>
                  <li>
          ...
          <li className="submenu">
            ...
            >
              ...
              <span>Challenges</span> <span className="menu-arrow" />
            </Link>
          ...
          <li className="submenu">
            ...
            >
              ...
              <span> Institutions</span> <span className="menu-arrow" />
            </Link>
